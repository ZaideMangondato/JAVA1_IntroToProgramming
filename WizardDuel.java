...
public class WizardDuel {
    public static void main(String args[]){
		System.out.println();
		System.out.println();
		System.out.println("created by: KALILANGAN PIONEERING INSTITUTE - KPI CONFESSION");
    ...
    public static void proceed1(){
		...
		System.out.println();
        System.out.println("-------------------------");
        System.out.println("     WIZARD's BATTLE");
        System.out.println("-------------------------");
        ...
        if(response == 1){
            ...
            System.out.println("First Opponent is WIZ\nMessage:\n   " + name + ", I'm sorry, but I'm telling you, You Cannot Defeat me! I'm the Strongests of all WIZARDS!");
            ...
            if(fight1 == 1){
                ...
                if(ranPowerPlayer > ranPowerComp1){
                    System.out.println("Nice Fight! You defeated Wiz, You can now proceed to the next LEVEL");
                    ...
                    System.out.println("WIZ: HAHAHAHAHA!!!! I told you " + name + " ,you cannot defeat me! I'm the STRONGEST!\nWAAAAAAHHHAAAAA!!!!!!!!");
    ...
    public static void levelTwo(){
        ...
        if(fight2 == 1){
                ...
                if(ranPowerPlayer > ranPowerComp2){
                    System.out.println("Nice Fight! You defeated " + oppName2 + ", You can now proceed to the next LEVEL");
                    System.out.println("Press \"1\" to proceed next LEVEL\nPress \"2\" to Quit");
                    int proc = input.nextInt();
                    if(proc == 1){
                        levelThree();
                    ...
                    System.out.println(oppName2 + " : HAHAHAHAHA!!!! I told you " + name + " ,you cannot defeat me! I'm the STRONGEST!\nWAAAAAAHHHAAAAA!!!!!!!!");
					System.exit(0);
        ...
        if(fight3 == 1){
              System.out.println(oppName3 + " Power: " + ranPowerComp2);
                ...
                if(ranPowerPlayer > ranPowerComp2){
                    ...
                    System.out.println(oppName3 + " : HAHAHAHAHA!!!! I told you " + name + " ,you cannot defeat me! I'm the STRONGEST!\nWAAAAAAHHHAAAAA!!!!!!!!");
                    System.exit(0);
        ...
        if(fight4 == 1){
              System.out.println(oppName3 + " Power: " + ranPowerComp2);
                ...
                if(ranPowerPlayer > ranPowerComp2){
                    ...
                    int proc = input.nextInt();
                    if(proc == 1){
                        JOptionPane.showMessageDialog(null, "Congratulations! You Defeated Severus Snape");
                        JOptionPane.showMessageDialog(null, "Thank you very much for Playing " + name);
						System.exit(0);
                    }
                    else if(proc == 2){
                        System.out.println("Thank you for playing");
