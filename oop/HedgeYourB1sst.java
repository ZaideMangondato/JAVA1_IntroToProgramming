...
public class HedgeYourB1sst extends JFrame {
    ...
    public static void main(String args[]){
        try{
        HedgeYourB1sst window = new HedgeYourB1sst();
        window.setVisible(true);
        }catch(Exception x){}
    }
        JLabel title = new JLabel("Each question has one correct answer");
        JLabel one = new JLabel("If you check 1 answer and it is correct it is = 5 pts");
        JLabel two = new JLabel("If you check 2 answers then it is = 2 pts");
        JLabel three = new JLabel("If you check all 3 answers = 1 pt");
	...
	JLabel points = new JLabel ("You have "+point+" points");
   	...
   	public HedgeYourB1sst()throws FileNotFoundException
    {
	...
	public class ClickButtonListener implements ActionListener {
        ...
        {               
			...
			if (question.getText().equals(q1)){
    			...
    			else if(q1a.isSelected() && q1b.isSelected() && !q1c.isSelected() || q1a.isSelected() && 
q1c.isSelected() && !q1b.isSelected() )
    			{
    				point += 2;
    			}
			...
			else if (question.getText().equals(q2))
			{
    			...
    			else if(q1b.isSelected() && q1a.isSelected() && !q1c.isSelected() || q1b.isSelected() && 
q1c.isSelected() && !q1a.isSelected() )
    			{
    				point += 2;
    			}
...
q1c.isSelected() && q1b.isSelected() )
			...
			else if (question.getText().equals(q4))
			 {
    			...
    			else if(q1c.isSelected() && q1b.isSelected() && !q1a.isSelected() || q1c.isSelected() && 
q1a.isSelected() && !q1b.isSelected() )
    			{
    				point += 2;
    			}
    			else if(q1a.isSelected() && !q1b.isSelected() && !q1c.isSelected())
