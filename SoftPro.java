...
public class SoftPro {
	...
	String rural_mode = "rural transit";
        String password_mode = "mangondato computer systems";
    ...
    public static void main(){
        ...
        System.out.println("               MCS - Mangondato Computer Systems\n-------------------------------------------------------------------\nOperating System:  Java Code Operating System CLI\nPowered by:        Java Programming Language");
        System.out.println("Created by:        © Soft-Pro Company\n");
    ...
    public static void proceed(){
        ...
        String author_mode = "soft-pro";
        Scanner input = new Scanner(System.in);
        System.out.print("MCS-COS >> ");
        ...
        if(response.equals(start_up)){
            ...
            System.out.println("MCS-COS >>              MCS Programs >>             MCS Calculator >>           Mulpur_calculator >>         ");
            System.out.println("=====================================================================================================\n");
            System.out.println("'programs'              'version'                   'addition'                  'age calculator'");
            System.out.println("'shutdown'              'calculator'                'subtraction'               'exit'");
            System.out.println("'soft-pro'              'random game'               'multiplication'");
            System.out.println("'show commands'         'exit'                      'division'");
            System.out.println("'refresh'               'switch RT mode'            'exit'");
            System.out.println("                        'noteword'");
            System.out.println("                        'mulpur calculator'");
            System.out.println("_____________________________________________________________________________________________________\n");
            proceed();
        }
    ...
    public static void mulpurCalc(){
        String response;
        String exit_mode = "exit";
        String age_calc = "age calculator";
        Scanner input = new Scanner(System.in);
        System.out.print("Mulpur_calculator >> ");
        response = input.nextLine();
        if(response.equals(age_calc)){
            int birthY;
            int yearT;
            int result;
            try{ 
                System.out.print("Enter Birth_Year >> ");
                birthY = input.nextInt();
                System.out.print("Enter Year_today >> ");
                yearT = input.nextInt();
                result = yearT - birthY;
                System.out.print("Age_calculation answer >> "+result+" yrs\n");
            }
    ...
    public static void Noteword(){
        ...
        System.out.print("");
        response = input.nextLine();
        if(response.equals(save_mode)){
            System.out.println("--(save)--");
            startConsole();
        }
        else if(response.equals(new_note)){
            System.out.println("----Notes above^ are discarded----\n");
    ...
    public static void calculator(){
            ...
            String exit_mode = "exit";
            System.out.print("MCS Calculator >> ");
            response = input.nextLine();
    ...
    public static void version(){
        System.out.println("MCS - Mangondato Computer Systems\n\nSoft-Pro Company\nJava Code Operating System - JCOS CLI\nVersion 2.0\n");
        startConsole();
    }
    public static void author(){
        System.out.println();
        System.out.println("© Soft-Pro Company\n");
        System.out.println("A Company of Softwares and Programs");
        System.out.println("Owned and Managed by:");
        System.out.println("Mr. Zaide A. Mangondato");
        System.out.println("");
        proceed();
    }
